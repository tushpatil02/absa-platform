...
![The recommender](docs/screenshots/recommender.png)

![A phone page](docs/screenshots/phone-page.png)

The phone page above is unretouched, and two of its ten quoted sentences show the
model getting it wrong: it reads *"it beat the heck out of the price in store"*
as negative about price, and files *"it's not unlocked like it said"* under
Processor. Those are visible because every score is traced to its sentence.
...
([recommender](docs/screenshots/recommender-dark.png) ·
[phone page](docs/screenshots/phone-page-dark.png) ·
[single review](docs/screenshots/single-review-dark.png) ·
